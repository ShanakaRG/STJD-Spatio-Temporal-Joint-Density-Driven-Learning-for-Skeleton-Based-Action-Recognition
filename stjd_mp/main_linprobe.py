...
def main(args):
    ...
    if args.finetune and not args.eval:
        ...
        n_parameters2 = sum(p.numel() for p in model.parameters())
        ...
        # # Get the parameters from both model components
        # params = list(model_without_ddp.head.parameters()) + list(model_without_ddp.lable_diff_decoder.parameters())

        # # # Initialize the optimizer with both sets of parameters
    ...
    if args.eval:
        ...
        print('test time', total_time_eval)
